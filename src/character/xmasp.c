...
static const CharFrame char_xmasp_frame[] = {
	{XmasP_ArcMain_Idle0, {0,   0, 221, 155}, {128, 182}}, //0 idle 1
	{XmasP_ArcMain_Idle1, {0,   0, 219, 147}, {127, 178}}, //1 idle 2
	{XmasP_ArcMain_Idle2, {0,   0, 210, 156}, {117, 179}}, //2 idle 3
	{XmasP_ArcMain_Idle3, {0,   0, 223, 148}, {127, 183}}, //3 idle 4
	
	{XmasP_ArcMain_LeftA0, {0,   0, 226, 156}, {123, 188}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 231, 159}, {125, 188}}, //5 left a 2
	{XmasP_ArcMain_LeftB0, {0,   0, 197, 200}, {122, 188}}, //6 left b 1
	{XmasP_ArcMain_LeftB1, {0,   0, 201, 200}, {125, 188}}, //7 left b 2
	
	{XmasP_ArcMain_DownA0, {0,   0, 200, 126}, {120, 168}}, //8 down a 1
	{XmasP_ArcMain_DownA1, {0,   0, 203, 126}, {122, 168}}, //9 down a 2
	{XmasP_ArcMain_DownB0, {0,   0, 213, 189}, {121, 177}}, //10 down b 1
	{XmasP_ArcMain_DownB1, {0,   0, 213, 190}, {123, 178}}, //11 down b 2
	
	{XmasP_ArcMain_UpA0, {0,   0, 231, 185}, {117, 190}}, //12 up a 1
	{XmasP_ArcMain_UpA1, {0,   0, 231, 165}, {120, 170}}, //13 up a 2
	{XmasP_ArcMain_UpB0, {0,   0, 197, 204}, {117, 191}}, //14 up b 1
	{XmasP_ArcMain_UpB1, {0,   0, 201, 202}, {119, 190}}, //15 up b 2
	
	{XmasP_ArcMain_RightA0, {0,   0, 238, 182}, {130, 174}}, //16 right a 1
	{XmasP_ArcMain_RightA1, {0,   0, 228, 161}, {130, 174}}, //17 right a 2
