...
static const CharFrame char_tank_frame[] = {
	{Tank_ArcMain_Idle0, {  0,   0, 214, 97}, { 106, 92}}, //0 idle 1
	{Tank_ArcMain_Idle0, {  0,  98, 214, 97}, { 106, 92}}, //1 idle 2
	{Tank_ArcMain_Idle1, {  0,   0, 204, 101}, {104,  95}}, //2 idle 3
	{Tank_ArcMain_Idle1, {  0, 102, 185, 124}, {100, 100}}, //3 idle 4
	
	{Tank_ArcMain_Left, {  0,   0, 190, 104}, {145, 102}}, //4 left 1
	{Tank_ArcMain_Left, {  0, 105, 187, 104}, {141, 102}}, //5 left 1
	
	{Tank_ArcMain_Down, {  0,   0, 159, 90}, {78, 76}}, //6 down 1
	{Tank_ArcMain_Down, {  0,  91, 162, 98}, {82, 84}}, //7 down 2
	
	{Tank_ArcMain_Up, {  0,   0, 138, 106}, {68,103}}, //8 up 1
	{Tank_ArcMain_Up, {  0, 107, 145,  95}, {74, 92}}, //9 up 2
	
	{Tank_ArcMain_Right, {  0,   0, 146, 101}, {65, 98}}, //10 right 1
	{Tank_ArcMain_Right, {  0, 102, 147, 101}, {74, 98}}, //11 right 2
