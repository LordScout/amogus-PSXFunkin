...
static const char *funny_messages[][2] = {
	{"PSXFUNKIN BY CUCKYDEV", "YOU KNOW IT"},
	{"PORTED BY LORD SCOUT", "MARIJUANA MAN"},
	{"AMONG US", "SUS"},
	{"CLOW", "FOE"},
	{"AYO THE PIZZA", "AINT HERE"},
	{"SUSSY BUSSY", "MY WUSSY"},
	{"YO MAMA", "IS INCREDIBLY FUNNY"},
	{"HELLO THIS IS", "THE IMPOSTER AMOGUS"},
	{"ARTHRITUS", "SKILL ISSUE"},
	{"THERE IS A SPY", "AMONG US"},
	{"KEEP POSTING", "ABOUT AMONG US"},
	{"WE'RE IN SPACE JAM MORTY", "IM CRANKING NINTIES MORTY"},
	{"SOFT MOD", "COMING"},
	{"CHRIS CHAN DOCUMENTARY", "GOD FUCKING HELP ME"},
	{"I SAW", "RED VENT"},
	{"SUS", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"},
	{"boo", "DID I GETCHA"},
	{"RED AND GREEN ARE GAY", "CRY ABOUT IT"},
	{"USE A CONTROLLER", "LOL"},
	{"SHITS UNOFFICIAL", "NOT A PROBLEM"},
	{"PERMISSION FOR PORT", "OBTAINED"},
	{"SHUT THE FUCK UP", "GODDAMN SHUT THE FUCK UP"},
...
void Menu_Tick(void)
{
			...
			else
			{
				...
				//Fallthrough
					...
					case 0:
						...
						menu.font_bold.draw(&menu.font_bold, "WITH HELP FROM", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "CUCKYDEV",   SCREEN_WIDTH2, SCREEN_HEIGHT2,      FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "CLOWFOE",      SCREEN_WIDTH2, SCREEN_HEIGHT2 + 16, FontAlign_Center);
						break;
					
					case 7:
						menu.font_bold.draw(&menu.font_bold, "TEAM FUNKTASTIC",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						Gfx_BlitTex(&menu.tex_ng, &src_ng, (SCREEN_WIDTH - 128) >> 1, SCREEN_HEIGHT2 - 16);
				//Fallthrough
					case 6:
					case 5:
						menu.font_bold.draw(&menu.font_bold, "ORIGINALLY MADE", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 64, FontAlign_Center);
				...
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "IMPOSTOR", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
	...
	//Fallthrough
		case MenuPage_Title:
		{
			...
			u32 x_rad = (logo_scale * (264 >> 1)) >> FIXED_SHIFT;
			u32 y_rad = (logo_scale * (168 >> 1)) >> FIXED_SHIFT;
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "POLUS", {"SUSSUS MOOGUS", "SABOTAGE", "MELTDOWN", NULL}},
				{"2", StageId_2_1, "MIRA HQ", {"SUSSUS TOOGUS", "LIGHTS DOWN", "MELTDOWN", "EJECTED"}},
				{"6", StageId_6_1, "SKELD", {"SUSSY BUSSY", "RIVALS", "CHEWMATE", NULL}},
				{"7", StageId_7_1, "???", {"DEFEAT", NULL, NULL, NULL}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, "SUSSUS MOOGUS"},
				{StageId_1_2, "SABOTAGE"},
				{StageId_1_3, "MELTDOWN"},
				{StageId_2_1, "SUSSUS TOOGUS"},
				{StageId_2_2, "LIGHTS DOWN"},
				{StageId_2_3, "REACTOR"},
				{StageId_2_4, "EJECTED"},
			...
			//Draw difficulty selector
			Menu_DifficultySelector(SCREEN_WIDTH - 55, SCREEN_HEIGHT2 - 7);
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_1, "VS IMPOSTOR PORT", false},
				{StageId_Kapi_2, "  LORD SCOUT", false},
				{StageId_Clwn_1, "PSXFUNKIN", false},
				{StageId_Clwn_2, "   CUCKDEV", false},
				{StageId_Clwn_1, "OWNERS", false},
				{StageId_Kapi_2, "   CLOWFOE", false},
				{StageId_Clwn_1, "   BLACKJOYSTICK", false},
				{StageId_Clwn_1, "   PIETRO ULTRA", false},
				{StageId_Clwn_1, "ARTISTS ", false},
				{StageId_Clwn_1, "   FABS", false},
				{StageId_Clwn_1, "   ITJULIAN ", false},
				{StageId_Kapi_1, "   SQUIDBOIEIGHTYFOUR", false},
				{StageId_Kapi_2, "   POSTMAN", false},
				{StageId_Clwn_1, "   INKY", false},
				{StageId_Clwn_2, "   ORBYY", false},
				{StageId_Clwn_1, "   PHEONIX", false},
				{StageId_Kapi_1, "COMPOSORS", false},
				{StageId_Kapi_2, "   ADAM MCHUMMUS", false},
				{StageId_Clwn_1, "   KEONI", false},
				{StageId_Clwn_2, "   RAREBLIN", false},
				{StageId_Kapi_2, "MISC CONTRIBUTORS", false},
				{StageId_Clwn_1, "   OFFBI", false},
				{StageId_Clwn_1, "   ETHANTHEDOODLER ", false},
				{StageId_Clwn_1, "   ANTHEMOVERLOAD", false},
				{StageId_Clwn_1, "   FARFOXX", false},
				{StageId_Kapi_2, "   SARUKY", false},
				{StageId_Clwn_1, "   MOONMISTT", false},
				{StageId_Clwn_1, "   KLUTCH ", false},
				{StageId_Clwn_1, "   GIBZ", false},
				{StageId_Clwn_1, "   XOOP", false},
				{StageId_Clwn_1, "   DOZENRAHYZ", false},
				{StageId_Clwn_1, "   ARTCARROT", false},
				{StageId_Kapi_2, "EJECTED BUILDING CODE", false},
